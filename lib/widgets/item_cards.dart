...
import '../screens/app_models.dart'; // Import state managers
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<int>(
          isExpanded: true,
          value: _selectedVariantIndex,
          icon: Icon(Icons.arrow_drop_down, size: 14, color: themeColor),
          dropdownColor: Colors.white,
          style: const TextStyle(
            color: Colors.black87,
            fontSize: 9,
      ...
      builder: (context, Map<String, int> counts, _) {
        ...
        if (count == 0) {
          return GestureDetector(
            onTap: () {
              var current = {...cartNotifier.value};
              current[itemId] = 1;
          ...
          return Container(
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(6),
              boxShadow: [
                BoxShadow(color: themeColor.withOpacity(0.3), blurRadius: 4),
              ],
            ),
            child: Row(
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, Set<String> favs, _) {
        ...
        Widget icon = Icon(
          ...
          color: isFav ? themeColor : Colors.grey.shade400,
          size: 16,
        );
