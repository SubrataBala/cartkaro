...
// ─────────────────────────────────────────────
const Color kTheme     = Color(0xFF4CAF50);  // Grocery green
...
class _GroceryProfileScreenState extends State<GroceryProfileScreen> {
  ...
  Widget _buildHero() {
    return Container(
      ...
      child: Row(
        children: [
          // Dynamic Initials Avatar - Changed from Black to Green
          Container(
            width: 72, height: 72,
            decoration: BoxDecoration(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text('Add Money', style: _s(size: 12, weight: FontWeight.w700, color: kTheme)), // Changed to Add Money
                    ],
                  ),
                ),
              ),
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: OutlinedButton(
                        ...
                        child: Text('Log Out', style: _s(size: 15, weight: FontWeight.w600, color: const Color(0xFF4CAF50))),
                      ),
                    ),
                  ),
