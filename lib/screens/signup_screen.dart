...
class _SignupScreenState extends State<SignupScreen>
  ...
  void _verifyAndCreate() async {
    ...
    // TODO: Verify OTP + create user account via your backend/Firebase
    await Future.delayed(const Duration(seconds: 1));
      ...
      child: Column(
        ...
        children: [
          ...
          TextFormField(
            ...
            style: const TextStyle(
                fontFamily: 'Poppins', fontSize: 15, color: kTextDark),
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      errorStyle: TextStyle(fontFamily: 'Poppins', fontSize: 11),
                    ),
  ...
  Widget _buildLoginLink() {
    return Center(
      child: RichText(
        text: TextSpan(
          style: const TextStyle(
              fontFamily: 'Poppins', fontSize: 14, color: kTextMuted),
          children: [
  ...
  InputDecoration _inputDecoration({
    ...
    return InputDecoration(
      ...
      hintStyle: const TextStyle(
          fontFamily: 'Poppins', fontSize: 14, color: Color(0xFFBDBDBD)),
      filled: true,
      fillColor: kSurface,
      prefixIcon: prefix ?? Icon(icon, color: kTextMuted, size: 20),
...
class _PerkChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Icon(icon, color: const Color(0xFF0C831F), size: 22),
