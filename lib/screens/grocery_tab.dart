              ...
              child: Row(
                children: [
                  Expanded(flex: 3, child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Container(padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 10), decoration: BoxDecoration(color: kGroceryGreen, borderRadius: BorderRadius.circular(8)), child: const Text('Shop Now', style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w700))),
                  ])),
  ...
  Widget _buildHeader(String title, bool showSeeAll) {
    return Padding(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        if (showSeeAll) const Text('See all', style: TextStyle(color: kGroceryGreen, fontSize: 13, fontWeight: FontWeight.w700)),
      ]),
    );
  }
}